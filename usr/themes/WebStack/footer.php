<footer class="main-footer sticky footer-type-1">
                <div class="footer-inner">
                    ...
                    <a href="https://www.zmki.cn/" target="_blank"><strong> ZMKI</strong></a>&nbsp;   Design BY <a rel="nofollow" href="http://webstack.cc" target="_blank"><strong>Webstack</strong></a>
                    &nbsp;&nbsp;版权所有:<b><?php $this->options->zmki_r(); ?></b>
					&nbsp;&nbsp;&nbsp;<a href="http://beian.miit.gov.cn/" rel="nofollow" target="_blank"><strong> <?php $this->options->zmki_icp(); ?> </strong></a>
                    </div>
