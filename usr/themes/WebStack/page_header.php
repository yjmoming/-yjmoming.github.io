...
<link rel="stylesheet" href="<?php $this->options->themeUrl('aliicon/font_1627571/iconfont.css'); ?>">
<script src="<?php $this->options->themeUrl('aliicon/font_1627571/iconfont.js'); ?>"></script>
<link rel="stylesheet" href="<?php $this->options->themeUrl('/css/nav.css'); ?>"> 
<script src="<?php $this->options->themeUrl('js/jquery.min.js'); ?>"></script>
...
<link rel="stylesheet" href="<?php $this->options->themeUrl('page/css/style_1.css'); ?>" type="text/css">
